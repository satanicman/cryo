            ...
            {foreach from=$view_data item=post}
                    ...
                    <div id="sds_blog_post" class="col-xs-12">
                       ...
                       {* </span>*}
                        ...
                        <p>
                            {$post.short_description|escape:'htmlall':'UTF-8'} <a href="{smartblog::GetSmartBlogLink('smartblog_post',$options)}"  class="r_more">{l s='(Подробнее...)' mod='smartbloghomelatestnews'}</a>
                        </p>
