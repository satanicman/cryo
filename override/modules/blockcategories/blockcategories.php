...
class BlockCategoriesOverride extends BlockCategories
{
	...
	public function install()
	{
		...
		if (!$tab->add() ||
			...
			!Configuration::updateValue('BLOCK_CATEG_INDEX', Cnfiguration::get('PS_HOME_CATEGORY')) ||
	...
	public function uninstall()
	{
		...
		if (!parent::uninstall() ||
			...
			!Configuration::deleteByName('BLOCK_CATEG_INDEX') ||
	...
	public function getContent()
	{
		...
		if (Tools::isSubmit('submitBlockCategories'))
		{
			...
			else
			{
				...
				Configuration::updateValue('BLOCK_CATEG_INDEX', Tools::getValue('BLOCK_CATEG_INDEX'));
	...
	public function getTree($resultParents, $resultIds, $maxDepth, $id_category = null, $currentDepth = 0)
	{
        ...
        $file = _THEME_CAT_DIR_.$id_category.'-0_thumb.jpg';
		$return = array(
			'id' => $id_category,
			'link' => $link,
            'thumb' => file_exists(_PS_ROOT_DIR_.$file) ? $file : '',
			'name' => $name,
			'desc'=> $desc,
			'children' => $children
		);
	...
	public function hookHomeTop($params)
	{
        $params['home'] = 1;
		...
		$fields_form = array(
			'form' => array(
				...
				'input' => array(
					...
					array(
						'type' => 'text',
						'label' => $this->l('ID on home'),
						'name' => 'BLOCK_CATEG_INDEX',
						'desc' => $this->l('Set id category on main page.'),
					),
					array(
						'type' => 'text',
	...
	public function getConfigFieldsValues()
	{
		return array(
			...
			'BLOCK_CATEG_INDEX' => Tools::getValue('BLOCK_CATEG_INDEX', Configuration::get('BLOCK_CATEG_INDEX'))
		);
	}
}
