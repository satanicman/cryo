...
class blocksocialOverride extends blocksocial
{
	...
	public function install()
	{
		return (parent::install() AND Configuration::updateValue('BLOCKSOCIAL_FACEBOOK', '') &&
			...
			Configuration::updateValue('BLOCKSOCIAL_FS', '') &&
	...
	public function uninstall()
	{
		...
		return (Configuration::deleteByName('BLOCKSOCIAL_FACEBOOK') AND
			...
			Configuration::deleteByName('BLOCKSOCIAL_FS') AND
	...
	public function getContent()
	{
		...
		if (Tools::isSubmit('submitModule'))
		{
			...
			Configuration::updateValue('BLOCKSOCIAL_FS', Tools::getValue('blocksocial_fs', ''));
		...
		$fields_form = array(
			'form' => array(
				...
				'input' => array(
					...
					array(
						'type' => 'text',
						'label' => $this->l('Foursquare URL:'),
						'name' => 'blocksocial_fs',
						'desc' => $this->l('Your official Foursquare account.'),
					),
					array(
						'type' => 'text',
	...
	public function getConfigFieldsValues()
	{
		return array(
			...
			'blocksocial_fs' => Tools::getValue('blocksocial_fs', Configuration::get('BLOCKSOCIAL_FS')),
